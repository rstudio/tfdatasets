...
To create a dataset, use one of the [dataset creation](reference/index.html#section-creating-datasets) functions. For example, to create a dataset from a text file, first create a specification for how records will be parsed from the file, then call `text_line_dataset()` with the file to be read and the specification:
...
iris_spec <- csv_record_spec(
  ...
  types = c("double", "double", "double", "double", "integer"), skip = 1
)
